        ...
        <Style.SectionBox marginTop={'-170px'} shadow backgroundColor={'#fff'} noPadding>
          ...
          <Style.Block flex direction={'row'} alignItems={'center'} justifyContent={'space-between'}>
            <Style.Block flex direction={'column'} alignItems={'center'}>
              <Style.Title size={'1em'} >Screen 1</Style.Title>
              <Style.Poster src="/images/screen1.jpg" />
              <Style.Paragraph >Some descriptions goes here</Style.Paragraph>
            </Style.Block>

            <Style.Block flex direction={'column'} alignItems={'center'}>
              <Style.Title size={'1em'} >Screen 2</Style.Title>
              <Style.Poster src="/images/screen2.jpg" />
              <Style.Paragraph >Some descriptions goes here</Style.Paragraph>
            </Style.Block>

            <Style.Block flex direction={'column'} alignItems={'center'}>
              <Style.Title size={'1em'} >Screen 3</Style.Title>
