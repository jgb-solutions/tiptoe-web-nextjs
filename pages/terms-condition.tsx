    ...
    <div>
      ...
      <div>
        <div>
          <div>
            <div >
              <div>Privacy Policy For Website</div>
              <div>
          ...
          {/* <div>
            ...
            <div size={'1.2em'} >Article 2 - GENERAL INFORMATION:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 3 -CONTACT AND DATA PROTECTION OFFICER:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 4 - LOCATION:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 5 - MODIFICATIONS AND REVISIONS:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 6 - THE PERSONAL DATA WE RECEIVE FROM YOU:</div>
            <div textAlign={'justify'}>
            ...
            <div marginTop={'-20px'}>
              <div>
                <div>
                  <div textAlign={'justify'}>
                    <div>a) Registered users:</div> You, as a user of the Website, may be asked to register in
                ...
                <div>
                  <div textAlign={'justify'}>
                    <div>b) Unregistered users:</div> If you are a passive user of the Website and do not register
                ...
                <div>
                  <div textAlign={'justify'}>
                    <div>c) All users:</div> The Passive Data Collection that applies to Unregistered users shall
                ...
                <div>
                  <div textAlign={'justify'}>
                    <div>d) Sales & Billing Information:</div> In order to purchase any of the services on the
                ...
                <div>
                  <div textAlign={'justify'}>
                    <div>e) Email Marketing:</div> You may be asked to provide certain Personal Data, such as
                ...
                <div>
                  <div textAlign={'justify'}>
                    <div>f) User Experience:</div> From time to time we may request information from you to
                ...
                <div>
                  <div textAlign={'justify'}>
                    <div>g) Content Interaction:</div> Our Website may allow you to comment on the content that
                ...
                <div>
                  <div textAlign={'justify'}>
                    <div>h) Combined or Aggregated Information:</div> We may combine or aggregate some of
            ...
            <div size={'1.2em'} >Article 7 - THE PERSONAL DATA WE RECEIVE AUTOMATICALLY:</div>
            <div textAlign={'justify'}>
              <div>Cookies:</div>  We may collect information from you through automatic tracking systems
            ...
            <div >
              <div marginTop={'-10px'}>
                <div>Technical cookies:</div> Technical cookies, which can also sometimes be called HTML
            ...
            <div >
              <div marginTop={'-10px'}>
                <div>Third-party cookies:</div> We may also utilize third-party cookies, which are cookies sent by a third-party to your computer. Permanent cookies are often third-party
            ...
            <div >
              <div marginTop={'-10px'}>
                <div>Support in configuring your browser:</div>  You can manage cookies through the
              ...
              <div marginTop={'-10px'}>
                <div>
                  ...
                  <div marginTop={'-10px'}>
                    ...
                    <div textAlign={'left'} style={{ color: '#262C63' }} >
            ...
            <div >
              <div marginTop={'-10px'}>
                <div>Log Data:</div> Like all websites and mobile applications, this Website also makes use of
            ...
            <div size={'1.2em'} >Article 8 - HOW PERSONAL DATA IS STORED:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 9 - PURPOSES OF PROCESSING OF PERSONAL DATA:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 10 - DISCLOSURE OF PERSONAL DATA:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 11 - PUBLIC INFORMATION:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 12 - OPTING OUT OF TRANSMITTALS FROM US:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 13 - MODIFYING, DELETING, AND ACCESSING YOUR INFORMATION:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 14 - ACCEPTANCE OF RISK:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 15 - YOUR RIGHTS:</div>
            <div textAlign={'justify'}>
            ...
            <div size={'1.2em'} >Article 16 - CONTACT INFORMATION:</div>
            <div textAlign={'justify'}>
